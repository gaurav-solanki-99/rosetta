...
//
//     final poDetailsObjectDetailsDistributor = poDetailsObjectDetailsDistributorFromJson(jsonString);

import 'dart:convert';

PoDetailsObjectDetailsDistributor poDetailsObjectDetailsDistributorFromJson(String str) => PoDetailsObjectDetailsDistributor.fromJson(json.decode(str));

String poDetailsObjectDetailsDistributorToJson(PoDetailsObjectDetailsDistributor data) => json.encode(data.toJson());

class PoDetailsObjectDetailsDistributor {
  PoDetailsObjectDetailsDistributor({
    this.po,
    this.alert,
  });
  ...
  factory PoDetailsObjectDetailsDistributor.fromJson(Map<String, dynamic> json) => PoDetailsObjectDetailsDistributor(
    po: PoDetailsObject2.fromJson(json["po"]),
    alert: json["alert"],
  );
...
class PoDetailsObject2 {
  ...
  Customer customer;
  Address address;
  List<PurchaseLine2> purchaseLines;

  factory PoDetailsObject2.fromJson(Map<String, dynamic> json) => PoDetailsObject2(
    id: json["id"],
    number: json["number"],
    ...
    purchaseLines: List<PurchaseLine2>.from(json["purchase_lines"].map((x) => PurchaseLine2.fromJson(x))),
  );
...
class Gst {
  ...
  factory Gst.fromJson(Map<String, dynamic> json) => Gst(
    number: json["number"],
    registrationType: Type.fromJson(json["registration_type"]),
    customerType: Type.fromJson(json["customer_type"]),
  );
...
class PurchaseLine2 {
  ...
  factory PurchaseLine2.fromJson(Map<String, dynamic> json) => PurchaseLine2(
    id: json["id"],
