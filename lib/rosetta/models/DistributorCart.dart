...
//
//     final distributorCart = distributorCartFromJson(jsonString);

import 'dart:convert';

List<DistributorCart> distributorCartFromJson(String str) => List<DistributorCart>.from(json.decode(str).map((x) => DistributorCart.fromJson(x)));

String distributorCartToJson(List<DistributorCart> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class DistributorCart {
  ...
  factory DistributorCart.fromJson(Map<String, dynamic> json) => DistributorCart(
    id: json["id"],
    ...
    stockPointId: json["stock_point_id"] == null ? null : json["stock_point_id"],
    distributorId: json["distributor_id"] == null ? null : json["distributor_id"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "stock_point_id": stockPointId == null ? null : stockPointId,
