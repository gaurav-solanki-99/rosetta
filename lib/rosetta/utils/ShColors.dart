...
// For R Gallery
const isrosetta = true;
 // const isrosetta = false;
// const sh_colorPrimary = Color(0xFF1261A0);
const sh_colorPrimary2 = Color(0xFF3895D3);
const secondColor = isrosetta?sh_colorPrimary:sh_colorPrimary2;
...
//Rosetta Flutter App
const sh_colorPrimary = Color(0xFFc8a05d);
// const sh_colorPrimary = Color(0xFF00316e);
const sh_colorbtn = Color(0xFF1167b1);

//For Credit Limit
// const sh_colorTotalCredit = Color(0xFF006699);
// const sh_colorAvaiableCredit = Color(0xFF3399CC);

const sh_colorTotalCredit = Colors.green;
const sh_colorAvaiableCredit = sh_colorPrimary;

//For Balance
const sh_colorBalance = Color(0xFF009966);
const sh_colorOverdue = Color(0xFFCCFF00);
...
const sh_colorPrimary_light = Color(0xffece3d7);
...
const sh_textColorEelevation = Color(0xFFcfcfcf);
const sh_textColorSecondarylight = Color(0xFFD4D2D2);
const sh_textColorSecondarylight2 = Color(0xFF727377);
const sh_textColorVerticleLine= Color(0xFFe3e2e7);
const sh_no_internet_background= Color(0xFFF2F2F2);
...
const sh_blockedBackGround=Color(0xFFFF7F1E7);
...
const sh_ColorPrimary2 = Color(0xFFEBEBEB);


const MaterialColor kPrimaryColor = const MaterialColor(
  0xFFc8a05d,
  const <int, Color>{
    50: const Color(0xFFc8a05d),
    100: const Color(0xFFc8a05d),
    200: const Color(0xFFc8a05d),
    300: const Color(0xFFc8a05d),
    400: const Color(0xFFc8a05d),
    500: const Color(0xFFc8a05d),
    600: const Color(0xFFc8a05d),
    700: const Color(0xFFc8a05d),
    800: const Color(0xFFc8a05d),
    900: const Color(0xFFc8a05d),
  },
);