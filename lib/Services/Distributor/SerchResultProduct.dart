...
import '../../rosetta/models/CollectionCategory.dart';
...
// example: Image.asset('images/camera.png',)
  ...
  ///////////////////////// TEST CODE CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
  List<String> banners=[];
  ...
  Future<List<ProductColor>> getCollectionCategory() async{
    ...
    if(result==200)
    {
      ...
      setState(() {
        ...
        print("Get Product By Nav Id Lenght is Search Pae CMS>>>>>>>>>>>>>>>>> "+prodcutsColorList.length.toString());
        print("Get Product By Nav Id Lenght is Search Pae CMS>>>>>>>>>>>>>>>>>$prodcutsColorList");
  ...
  ///////////////////////////////////////////////////////////////// TEST CODE CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
  ...
  getCollection() async{
    print ("SEARCH PAGE +++++++++++++++++++++++++++++TEST TEST TEST TEST ");
    ...
    map['category_id'] = widget.id.toString();
    ...
    print("SEARCH PAGE COLLECTION RESPONSE TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT");
  ...
  getMainCategory() async{
    ...
    print("TTTTTTTTTTTTTTTTTTTTTTT MAIN MAIN TTTTTTTTTTTTTTTTTTTTTTT");
...
// You can request multiple permissions at once.
  ...
  Future<bool> getPdfLink(String itemCode) async{
    ...
    print("Single PDF Api Methode call   $itemCode  $getPdfLinkresult");
  ...
  Future<int> getCollectivePdfLink(String itemCode) async{
    ...
    var  uri = API_CMS_BASE_URL+"/api/webservices/getProductPdfForColorCode";

    var map = new Map<String, dynamic>();

    var is_rgallery_app = pdfIconValue;
    //API_ROS_PROD__BASE_URL=="http://ros.rosettaproducts.com"?"0":"1";
    print(" getProductPdfForColorCode >>>>>>>>>>> "+jsonEncode({"product_color_code":allSelectedColorCode,"is_rgallery_app":is_rgallery_app}));
    ...
    var res = await http.post(Uri.parse(uri),body: jsonEncode({"product_color_code":allSelectedColorCode,"is_rgallery_app":is_rgallery_app}));
    print("Response From Json Array "+res.body +'{"product_color_code":$allSelectedColorCode}');
  ...
  getSessionData() async
  {
    ...
    if(token.isNotEmpty)
    {
      ...
      print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>Value for Search >>>>>>>>>>>>>>>>>>>>>>"+widget.SelectedDealer2);
      ...
      getCollectionCategory().then((value){
  ...
  Future<List<Inventory>> SearchProduct(String SuggestValue) async {
    ...
    else
    {
      ...
      else if(MyMemberType=="DUD")
      {
        ...
        print("DUD my MyNavDistrributorId is $Myparent_distributor_id");
    ...
    print("TTTTTTTTTTTTTTTTTTTTTTTTT RESUL SERCH API ");
    print(response.body.length);
    ...
    else
    {
      ...
      if(SearchProductsList.fromJson(json.decode(response.body)).inventory.length==0)
      {
        ...
        {
          print("NAvigator 1 >>>>>>>>>>>>>>>>>>>>>>>>>>>> Inventory not found1");
        }
      }
      else
      {
  ...
  void search_on_Type(String value)
  {
    ...
    for(int i =0; i < spinnerSelectCollection.length; i++)
    {
      ...
      if(spinnerSelectCollection[i].value == value.toUpperCase())
      {
        ...
        widget.SelectedValue =   spinnerSelectCollection[i].value;
        ...
        //category=CARPET
        widget.SelectedAutoSuggestStirng="$SelectedCode="+widget.SelectedValue;
      }
  ...
  Future<List<SpinnerSpinnerDealerList>> getDealerList() async {
    print("Get SpinnerDealer List Methode Call >>>>>>>>>>>>>>>>>> Search Result Page");
    ...
    setState(() {
      ...
      if(responseCode==200)
      {
        ...
        if(widget.spinnerDelerList.length==0)
        {
          setState(() {
            widget.isDealerAvailbe=false;
  ...
  get_All_Collection_Categoty_ColorCde(String User) async {
    ...
    print("get_All_Collection_Categoty_ColorCde Memeber Type is >>>>>>>>>>>>>>>>>>>>>>>>>> $MyMemberType");



    if(MyMemberType=="Distributor")
    {
      print("get get_All_Collection_Categoty_ColorCde usertype >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> $User");
    ...
    return    MediaQuery(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child:MyAppBar(false,"",MyUserName,isVisibleSkip,true),
        ),
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    //color: Colors.red,
                    child: (widget.listsearchProducts.length!=0 && listOfCMSColors.length!=0)?
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index)
                        {
                          ...
                          displayNameColor= widget.listsearchProducts[index].colour!=null?widget.listsearchProducts[index].colour.displayName:"";
                          var NewQuantity = widget.listsearchProducts[index].inventory!=0?widget.listsearchProducts[index].inventory.toStringAsFixed(2):"0";//toStringAsFixed(2)
                          //GM9 var NewQuantity = widget.listsearchProducts[index].inventory!=0?widget.listsearchProducts[index].inventory.truncateToDouble().toStringAsFixed(0):"0";//toStringAsFixed(2)
                          ...
                          print(widget.listsearchProducts.length);
                          print("TTTTTTTTTTTTTTTTTKKKKKKKKKK");
                          print( NewImageUrl);
                          ...
                          print("##   colour  In  Mutiple Size "+widget.listsearchProducts[index].colour.inMultiples.toString());
                          print("##   colour In  Plank Size "+widget.listsearchProducts[index].colour.plankSize.toString());
                          print("##   collection In  Mutiple Size "+widget.listsearchProducts[index].collection.inMultiples.toString());
                          print("##   collection   In  Plank Size "+widget.listsearchProducts[index].collection.plankSize.toString());
                          print("##   category  In  Mutiple Size "+widget.listsearchProducts[index].category.inMultiples.toString());
                          print("##   category   In  Plank Size "+widget.listsearchProducts[index].category.plankSize.toString());
                          ...
                          return widget.listsearchProducts.length != null ?//listOfCMSColors.contains(displayNameColor) ?
                          Container(
                            // height: 240,
                                    ...
                                    InkWell(
                                      ...
                                      onTap: ()
                                      {
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => SearchResultProductDeatails(
                                            id: widget.listsearchProducts[index].navId,MyPageTitle:""+widget.listsearchProducts[index].category.displayName,isnavId:true,listsearchProducts:widget.listsearchProducts,SelectedProductDetailt:widget.listsearchProducts[index],SelectedValueForSearch:widget.SelectedValueForSearch,SelectedDealer2:widget.SelectedDealer2,spinnerDealerSelectes: widget.spinnerDealerSelectes,rateTypeDescription: rateTypeDescription,plankSize: plankSize,in_multipels: in_multipels,SelectedQuantity: widget.SelectedQuantity,collectionName:widget.listsearchProducts[index].collection.displayName)));
                                                      ...
                                                      else
                                                      {
                                                        ...
                                                        if(displayNameColor!="")
                                                        {
                                                          ...
                                                          else
                                                          {
                                                            ...
                                                            allSelectedColorCode.add(widget.listsearchProducts[index].navId);
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                ...
                                                style: TextStyle(fontSize: textSizeLargeMedium,color:isrosetta?sh_colorPrimary:sh_colorPrimary2
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child:( widget.listsearchProducts[index].inventory!=0)?
                                                  Text(" Stock $NewQuantity "+widget.listsearchProducts[index].baseUnitOfMeasure,style: TextStyle(
                                                      color: sh_textColorSecondary,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                    ...
                                                    child:Text(" Block "+widget.listsearchProducts[index].blocked.toStringAsFixed(2)+" "+widget.listsearchProducts[index].baseUnitOfMeasure,style: TextStyle(
                                                        color: sh_textColorSecondary,
                                                        fontSize: textSizeMedium,fontWeight: FontWeight.w500),)
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if(displayNameColor!="")
                                                  {
                                                    ...
                                                    singlePdfCall=true;
                                                    isSinglePDFDownload=false;
                                                    //widget.listsearchProducts[index].price
                                                    showAlertDialogPDF(context,setState,widget.listsearchProducts[index].navId);  //showAlertDialogPDF(context,setState,displayNameColor);
                                              ...
                                              InkWell(
                                                ...
                                                onTap:(){
                                                  isInternatAvailable2(context);
                                                  String string = displayNameColor.replaceAll(RegExp(' '), '%20');
                                              ...
                                              // For Select Lot
                                              isVisibleSkip?Container():  Container(
                                                //NewQuantity==115.0
                                                child:(false)?
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.start,
        ...
        endDrawer: isVisibleSkip?null:MyDrwaer(),
      ),
    );
  }
                      ...
                      getPdfLink(displayNameColor).then((value) async {
                        ...
                        if(value==true)
                        {
                          if(getPdfLinkresult)
                          {
                            ...
                            //27April2022
                            String newDate = widget.SelectedValue+"_"+(formatted2.split(" ")[1]+formatted2.split(" ")[0]+formatted2.split(" ")[2]).replaceAll(",", "");
                      ...
                      if(collectivePdfCall)
                      {
                        ...
                        getCollectivePdfLink(displayNameColor).then((value) async
                        {
                          ...
                          if(value==200)
                          {
                            ...
                            fullPath = "$path/$folderName/"+"$newDate"+"_"+pdfCount.toString()+".pdf";
                                        ...
                                        child:Autocomplete(
                                          ...
                                          fieldViewBuilder: (BuildContext context,
                                            ...
                                            return TextFormField(
                                              ...
                                              readOnly: widget.spinnerDelerList.length==0?true:false,
                                              // readOnly: !widget.isDealerAvailbe,
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:widget.spinnerDelerList.length==0? "No Dealers Available":"Search Dealers",
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              onChanged: (value){
                                                ...
                                                {
                                                  widget.isDecimalValue=false;
                                                }
                                                else
                                                {
                                                  widget.isDecimalValue=true;
                                          ...
                                          child:   Container(
                                            ...
                                            child: MaterialButton(
                                              ...
                                              onPressed: () => {
                                                ...
                                                if(widget.SelectedAutoSuggestStirng!=null && widget.SelectedQuantity!=null && widget.isDecimalValue==false )
                                                  {
                                                    ...
                                                    SearchProduct(widget.SelectedAutoSuggestStirng).then((value) async {
                                                      ...
                                                      if(responseLength!=0)
                                                      {
                                                        ...
                                                        if(isLoadAll){
                                                          print("NAvigator 2 >>>>>>>>>>>>>>>>>>>>>>>>>>>> Inventory not found");
                                                          Navigator.of(context, rootNavigator: true).pop();
                                                          Navigator.of(context, rootNavigator: true).pop();
                                                        ...
                                                        {
                                                          print("NAvigator 2 >>>>>>>>>>>>>>>>>>>>>>>>>>>> Inventory not found1");
                                                        }
                                                      ...
                                                      if(widget.listsearchProducts.length==0)
                                                      {
                                                        ...
                                                        //  Navigator.of(context, rootNavigator: true).pop();
                                                        if(isLoadAll){
                                                          print("NAvigator 3 >>>>>>>>>>>>>>>>>>>>>>>>>>>> Inventory not found");
                                                          Navigator.of(context, rootNavigator: true).pop();

                                                        }
                                                        else
                                                        {
                                                          print("NAvigator 3 >>>>>>>>>>>>>>>>>>>>>>>>>>>> Inventory not found1");
                                                        }
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~For Strorage issues in Android 10
