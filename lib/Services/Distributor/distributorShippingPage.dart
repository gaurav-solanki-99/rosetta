...
class ShWishlistFragmentState extends State<DistributorShipingDetails> {
  ...
  final TextEditingController address_twoController = TextEditingController();
  Image img;
// example: Image.asset('images/camera.png',)
      ...
      for(int i=0;i<distributorAllTransporterDetails.length;i++)
      {
        ...
        setState(() {
          ...
          else
          {
            ...
            {
             //AAAAAAAAAA MY_CHANGE spinnerSelectTransporterDetails.add(distributorAllTransporterDetails[i].name+"*");
            }
            else
            {
              spinnerSelectTransporterDetails.add(distributorAllTransporterDetails[i].name);
  ...
  getTransporterListDealer() async {
    ...
    //       {
    //         spinnerSelectTransporterDetails.add(distributorAllTransporterDetails[i].name);
    //         displayname = distributorAllTransporterDetails[i].name;//spinnerSelectTransporterDetails[i];
    //         // selectedTranspor=DealerName;
    //       }
    //
    //     });
  ...
  getTransporterListDUDDUC() async {
    ...
    if(responseCode==200)
    {
      ...
      int TransporterDetailsLength =  distributorAllTransporterDetails.length;
      print("New TransporterDetailsLength  List   Length 33333 >>>>>>>>>>>>>>> $TransporterDetailsLength ");
      /// MY CHANGES LOOP
                              ...
                              child: new DropdownButton<String>(
                                ...
                                onChanged: (String value) {
                                  setState(() {
                                    ...
                                    // value =  selectedTranspor.isNotEmpty ? selectedTranspor : null ;


                                    final index = distributorAllTransporterDetails.indexWhere((element) => element.name == selectedTranspor);
                                ...
                                items: spinnerSelectTransporterDetails.map<DropdownMenuItem<String>>(
                                        (String value) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      keyboardType: TextInputType.emailAddress,
                                      inputFormatters: [
                                        new LengthLimitingTextInputFormatter(51),
                                      ],
                                      autofocus: false,
                                      ...
                                      validator: (String value) {
                                        if (value.length == 50) {
                                          ...
                                          return 'Please enter remaining address in Address 2.';
                                        }
                                    ...
                                    TextFormField(
                                      ...
                                      validator: (String value) {
                                        if (value.length == 50) {
                                          ...
                                          print("Mob no should be 10 Digits");
                                          return 'Address 2 can not exceed 50 characters.';
                                        }
                                        ...
                                        fieldViewBuilder: (BuildContext context,
                                          ...
                                          return TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              fillColor: sh_editText_background,//backgroundSearchProductFormInput,
                                              focusColor: sh_editText_background_active,
