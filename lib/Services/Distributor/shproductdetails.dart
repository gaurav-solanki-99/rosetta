      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            ...
            children: [
              Image.asset(ic_download_round,height: 30,width: 30,),
              SizedBox(
                width: 5,
              ),

              Image.asset(ic_share_round,height: 30,width: 30,),
              SizedBox(
                width: 5,
              ),
              Image.asset(ic_technical_round,height: 30,width: 30,),
              SizedBox(
                width: 5,
              ),
              Image.asset(ic_viewOtherVariant,height: 30,width: 30,),
                    ...
                    children: [
                       Container(
                         margin: EdgeInsets.only(left: 15,bottom: 15),
                           child: Text("Category",style: TextStyle(fontSize:14,color: Colors.black,fontWeight: FontWeight.bold),)),
                      Row(
                         mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                             Image.asset(ic_category_image,height: 100,width: 100,),
                            Image.asset(ic_category_image,height: 100,width: 100,),
                            Image.asset(ic_category_image,height: 100,width: 100,),
                          ],
                      ),
