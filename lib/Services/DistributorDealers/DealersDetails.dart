...
class DealersDeatails extends StatefulWidget {
  String dealersId;
   DealersDeatails(this.dealersId);

  @override
  _DealersDeatailsState createState() => _DealersDeatailsState();
}

class _DealersDeatailsState extends State<DealersDeatails> {
    ...
    return MediaQuery(
        ...
        Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child:MyAppBar(false,"Profile","",false,true),
          ),
          body: SafeArea(
