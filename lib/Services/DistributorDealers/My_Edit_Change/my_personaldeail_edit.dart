...
class MyPersonalDeatilsForm extends StatefulWidget {
  String dealer_type;
  bool isEditDeler;
  List<SpinnerSpinnerDealerList> spinnerDelerList = [];
  SpinnerSpinnerDealerList selectDealer;
  DealersDetsils dealersDetsils;
  MyPersonalDeatilsForm(this.dealer_type,this.isEditDeler,this.selectDealer,this.dealersDetsils);

  //get spinnerDelerList => null;

  @override
  _MyPersonalDeatilsFormState createState() => _MyPersonalDeatilsFormState();
}

class _MyPersonalDeatilsFormState extends State<MyPersonalDeatilsForm> {
  int val = 1;
  ...
  //DealersDetsils get dealersDetsils => null;
  ...
  void initState() {
    ...
    if(widget.isEditDeler)
    {
      ...
      setState(()
      {
        ...
        if(widget.dealersDetsils.city.toString().isEmptyOrNull)
        {
          isCityEdit=true;

        }

        if(widget.dealersDetsils.phone.toString().isEmptyOrNull)
        {
          isPhoneEdit=true;

        }
        if(widget.dealersDetsils.address.toString().isEmptyOrNull)
        {
          isAddress1dit=true;
    ...
    return MediaQuery(
        ...
        Scaffold(
          ...
          appBar: PreferredSize(
                ...
                title: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Text("Personal Details Update",style: TextStyle(color: sh_textColorPrimary,fontWeight: FontWeight.bold,fontSize: textSizeMedium),))
            ...
            // child:widget.isEditDeler?MyAppBar(true,"   Personal Deatils Update","",false,true):
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                //widget.isEditDeler==false?Container():
                                ...
                                //     //
                                //     //             // CHANGES
                                //     //             // readOnly:  phone.isEmpty?(isPhoneEdit?true:false):true,//widget.isEditDeler?(isPhoneEdit?false:true):false,
                                //     //
                                //     //             onChanged: (value){
                                //     //
                                //     //               setState(() {
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: SizedBox(
                                              ...
                                              child:
                                              TextFormField(
                                               // enabled: phone.isEmpty&& phone.length!=10?true:false,
                                               // enabled:phone.length!=10 ?true:false,
                                                ...
                                                // CHANGES
                                               // readOnly:  phone.length>0==10?(isPhoneEdit?true:false):false,//widget.isEditDeler?(isPhoneEdit?false:true):false,
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(color:
                                            isValidphone?sh_textColorSecondarylight:Colors.red, width: 1,),
                                            borderRadius: BorderRadius.all(Radius.circular(5)),
                                          ),
                                ...
                                Container(
                                  ...
                                  SizedBox(
                                      ...
                                      SizedBox(
                                          ...
                                          //  enabled:phone.length!=10 ?true:false,
                                            //enabled:widget.city.isEmpty?true:false,
                                            //   enabled: city.isEmptyOrNull?true:false,
                                           //  enabled:widget.dealersDetsils.city.contains(city) ?true:false,
                                            keyboardType: TextInputType.text,
                                            autofocus: false,
                                            initialValue: city,
                                          //  readOnly:  widget.isEditDeler?(iscontactPersonEdit?false:true):false,
                                            readOnly: widget.isEditDeler?(isCityEdit?false:true):false,
                                            //readOnly: isCityEdit?false:true,
                                            onChanged: (value){
                                              setState(() {
                                                city=value;
                                                widget.dealersDetsils.city = city;
                                ...
                                Container
                                  ...
                                  child:  SizedBox(
                                      ...
                                      TextFormField(
                                        ...
                                        // keyboardType:  TextInputType.phone,//TextInputType.numberWithOptions(signed: true, decimal: true),
                                        // inputFormatters: [
                                        //   new LengthLimitingTextInputFormatter(6),
                                        // ],
                                        autofocus: false,
                                          ...
                                          InkWell(
                                              ...
                                              async  {
                                                 ...
                                                 else
                                                {
                                                  ...
                                                  print(MyCompanyId+ MyMemberId + ""+ widget.dealersDetsils.id.toString());
                                                  print(">>>>>>>>>>>>>>>>>>>>>>G1"+dealersDetsils.toString());
                                                  print(">>>>>>>>>>>>>>>>>>>>>>G2"+widget.dealersDetsils.toString());
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => MyPaymentTermsForm(
                                                      "",
                                                      "",
                                                      "",
                                                      "",
