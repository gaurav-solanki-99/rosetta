...
class _PaymentTermsFormState extends State<PaymentTermsForm> {
  ...
  void initState() {
    ...
    print("KKKKKKKKKKKKKKKKKKKKKKKK"+ payment_term_list.length.toString());
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child:  new DropdownButton<String>(
                                  ...
                                  value:isPtermsSelected? selected_PaymentTerms : spinnerAllPaymentTerms.isNotEmpty?spinnerAllPaymentTerms[1]:selected_PaymentTerms,  //widget.paymentTerms,
                                  //selected_PaymentTerms,
                                  // value: spinnerAllPaymentTerms.isNotEmpty?isPtermsSelected? selected_PaymentTerms:widget.paymentTerms:selected_PaymentTerms,
                                  // value:
                                  // widget.isEditDeler?selected_PaymentTerms:spinnerAllPaymentTerms.isNotEmpty?isPtermsSelected? selected_PaymentTerms:widget.paymentTerms:selected_PaymentTerms,
                                  hint: new Text(""),
                                  isExpanded: true,
                                  icon: Icon(
                              ...
                              Container(
                                ...
                                child:  new DropdownButton<String>(
                                  ...
                                  value:isPMethodeSelected? selected_PaymentMethod : spinnerAllPaymentMethod.isNotEmpty?spinnerAllPaymentMethod[1]:selected_PaymentMethod,
                                  // value: widget.isEditDeler?selected_PaymentMethod: spinnerAllPaymentMethod.isNotEmpty? isPMethodeSelected? selected_PaymentMethod:widget.paymentMethod :selected_PaymentMethod,
                              ...
                              Container(
                                ...
                                SizedBox(
                                    ...
                                    TextFormField(
                                      ...
                                      initialValue:widget.credit_limit ,
                                      autofocus: false,
                                      onChanged: (value){
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(onTap: () async {
                                  ...
                                  if(widget.credit_limit.isEmptyOrNull)

                                  {
                                    print("TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT"+widget.credit_limit.toString());
