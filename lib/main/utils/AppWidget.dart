...
import 'package:rosetta_fluter_app/main/model/ListModels.dart';
import 'package:rosetta_fluter_app/integrations/utils/common.dart';
...
class ExampleItemWidget extends StatelessWidget {
  ...
  ExampleItemWidget(this.tabBarType, { this.onTap, this.showTrailing = false});
