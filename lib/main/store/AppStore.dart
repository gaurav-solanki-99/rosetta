...
import 'package:rosetta_fluter_app/main/model/AppModel.dart';
import 'package:rosetta_fluter_app/main/utils/AppColors.dart';
import 'package:rosetta_fluter_app/main/utils/AppConstant.dart';

import 'package:rosetta_fluter_app/local/Languages.dart';
...
abstract class AppStoreBase with Store {
  ...
  Future<void> setLanguage(String val, {BuildContext context}) async {
    ...
    if (context != null) var language = BaseLanguage.of(context);
